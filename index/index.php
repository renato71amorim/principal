...
// 
      ...
      elseif (!isset($_SESSION['scriptcase']['index']['actual_lang']) || $_SESSION['scriptcase']['index']['actual_lang'] != $this->str_lang) {
          ...
          setcookie('sc_actual_lang_Index',$this->str_lang,'0','/');
      }
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
/*NM*/            $_SESSION['scriptcase']['index']['glo_nm_perfil'] = $NM_con_dest;
      ...
      {
          ob_start();
          db_conect_devel($con_devel, $this->root . $this->path_prod, 'Index', 2, $this->force_db_utf8); 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['index']['glo_nm_conexao'], $this->root . $this->path_prod, 'Index', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   {
       if (empty($conex) || $conex == "principal")
       {
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       if (isset($_COOKIE['sc_apl_default_Index'])) {
           $apl_def = explode(",", $_COOKIE['sc_apl_default_Index']);
       }
       elseif (is_file($root . $_SESSION['scriptcase']['index']['glo_nm_path_imag_temp'] . "/sc_apl_default_Index.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['index']['glo_nm_path_imag_temp'] . "/sc_apl_default_Index.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "index") {
           ...
           if (isset($_COOKIE['sc_actual_lang_Index'])) {
               $_SESSION['scriptcase']['index']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Index'];
           }
       }
   }
